...
task msgfplus {
    ...
    runtime {
        docker: 'ghcr.io/microbiomedata/nmdc-metapro-msgfplus:v2022.04.18'
    }
}
task mzidtotsvconverter{
    ...
    runtime {
        docker: 'ghcr.io/microbiomedata/nmdc-metapro-mzidtotsvconverter:v1.4.6'
    }
}
...
#        -T:~{mass_correction_params} \
    ...
    runtime {
        docker: 'ghcr.io/microbiomedata/nmdc-metapro-peptidehitresultsprocrunner:v3.0.7842'
    }
}
...
task fastaFileSplitter {
    ...
    runtime {
        docker: 'ghcr.io/microbiomedata/nmdc-metapro-fastafilesplitter:v1.1.7887'
    }
}
task msgfplusresultsmerge {
    ...
    runtime {
        docker: 'ghcr.io/microbiomedata/nmdc-metapro-mzidmerger:v1.4.26'
    }
}
